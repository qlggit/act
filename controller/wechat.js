...
router.get('/entrance', function(req, res, next) {
    ...
    req.session.subscribe = req.query.subscribe;
    ...
    useSession.save(req , res , function(){
        useData.getUserInfo(wechat_info , function(){
...
router.post('/subscribe',useValidate.checkSubscribe, function(req, res, next) {
    res.sendSuccess();
});
